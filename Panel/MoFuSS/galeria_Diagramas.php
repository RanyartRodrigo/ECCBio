    ...
    $numfilas = $result->num_rows;
     for ($x=0;$x<$numfilas;$x++) {
        $fila = $result->fetch_object();
                ...
                <img class="galeriaImg" src="uploads/diagramas/'.$fila->nombre.'" onClick="Galeria(this, 0)" title="'.$fila->nombre.'"/>
                ';               
     }
  ?>
...
$("#imgGaleriaCambiar"+tipo).trigger("click");
            ...
            $.ajax({
                url: "MoFuSS/galeriaDiagramModel.php",
                type: "post",
                dataType: "html",
                data: formData,
                cache: false,
       ...
       processData: false
                ...
                .done(function(res){
                         //$("#Contenidos").load("MoFuSS/diagram.php",{id:$("#id").val()});
                         location.reload();
              })
