	...
	\begin{python}
		...
		for file in files:
		   ...
		   if(tipo[0] == '0'):
		      ...
		      print r"\multirow{6}{*}{\textcolor{brown}{Temperatura m\'inima (C)}} & \multirow{2}{*}{2015-2039} & \multirow{2}{*}{"
		      print r"%s" %rl
		      rl = infoTabla.readline()[:-1]
		      print r" y %s" %rl
		      rl = infoTabla.readline()[:-1]
		      ...
		      print r" & & & \\"
		      rl = infoTabla.readline()[:-1]
		      print r"\multirow{6}{*}{\textcolor{orange}{Temperatura media (C)}} & \multirow{2}{*}{2015-2039} & \multirow{2}{*}{%s" %rl
		      rl = infoTabla.readline()[:-1]
		      print r" y %s" %rl
		      rl = infoTabla.readline()[:-1]
		      print r"}  & \multirow{2}{*}{%s" %rl
		      ...
		      print r" & & & \\"
		      rl = infoTabla.readline()[:-1]
		      print r"\multirow{6}{*}{\textcolor{red2}{Temperatura m\'axima (C)}} & \multirow{2}{*}{2015-2039} & \multirow{2}{*}{%s" %rl
		      rl = infoTabla.readline()[:-1]
		      print r" y %s" %rl
		      rl = infoTabla.readline()[:-1]
		      print r"}  & \multirow{2}{*}{%s" %rl
		   ...
		   print r"\centering"
		   print r"\includegraphics[trim= 0 0 0 80, clip, width=12cm,height=12cm]{%s}" % (directory+file[0]+'N')
		   ...
		   print r"\begin{figure}[!ht]"
		   print r"\centering"
		   print r"\includegraphics[trim= 0 0 0 80, clip, width=12cm,height=12cm]{%s}" % (directory+file[0])
