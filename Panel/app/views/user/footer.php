<?php 
	...
	function tourDe($part){
		...
		if($part=="country")country();	
                ...
                if($part=="layers")layers();
                if($part=="panel")panel();
                if($part=="identificadores")identificadores();
                if($part=="galeria")galeria();
                if($part=="diagram")diagram();
                if($part=="suelo")suelo();
                if($part=="submenus")submenus();
                if($part=="countryShow")paisesShow();
                if($part=="layersStyle")layersStyle();
		echo '</script>';
	}
	function country(){
        echo '
        ...
        if(act=="#close#"){
           ...
           $(".cortina").remove();
            ...
            setTimeout(function(){
                ...
                if(next!=undefined)$("#banner").after('<i class="fa fa-chevron-circle-right next cortina" onClick="Tour(\''+next+'\')"></i>');
