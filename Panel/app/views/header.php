...
<head>
	...
	<link href="<?php echo asset_url("css/colors/general.php") ?>" rel="stylesheet" id="color_scheme">
	          	...
	          	<ul class="nav navbar-nav navbar-pull-right">
	          		...
	          		<?php if (Auth::check()): ?>
	          			<?php if (Auth::userCan('dashboard'))
			          			echo '
			          				<li>
			          					<a href="admin.php" class="nav-btn" data-toggle="tooltip" data-placement="bottom" title="main.admin_dashboard">
			          			...
			          			echo '
			          				<li>
			          					<a href="user.php" class="nav-btn" data-toggle="tooltip" data-placement="bottom" title="main.admin_dashboard">
			          						<span class="glyphicon glyphicon-cog"></span>
			          					</a>
			          				</li>';
	          			?>
