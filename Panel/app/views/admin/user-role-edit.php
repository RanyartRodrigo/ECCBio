...
<div class="row">
	<div class="col-md-6">
		<?php if ($role): ?>
            ...
            <span class="label label-default">manage_researchareas</span>
            <span class="label label-default">manage_projects</span>
            <span class="label label-default">list_researchareas</span>
            <span class="label label-default">list_projects</span>
            <span class="label label-default">manage_events</span>
            <span class="label label-default">list_projects</span>
