...
<head>
	...
	<script src="https://cloud.tinymce.com/5/tinymce.min.js?apiKey=7hzgyfla201ic0p4c1u2jw4gax59m8rxwmrsjho6hios8yov"></script>
        	...
        	<div class="navbar-collapse collapse">
	          	<ul class="nav navbar-nav">
                	<li class="<?php echo active_menu('return') ?>">
                    	<a href="http://www.wegp.unam.mx/sicabioenergy"><span class="glyphicon glyphicon-hand-left"></span> Sitio Web CONABIO</a>
                    </li>
                    ...
                    <?php endif ?>
                     	...
                     	<li class="dropdown <?php echo active_menu('CONABIO') ?>">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown">
								<span class="glyphicon glyphicon-th-large"></span> <?php _e('admin.CONABIO') ?> <b class="caret"></b>
							</a>
