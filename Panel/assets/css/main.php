...
/* Image */
	...
	.image {
		...
		display: inline-block;
		position: relative;
		box-shadow: 0px 0px 0px 7px $cajas, 0px 0px 0px 8px rgba(0, 0, 0, 0.1);
	}
	...
	.wrapper {
		...
		.wrapper.style2 {
			...
			.wrapper.style2 .image {
				box-shadow: 0px 0px 0px 7px $texto, 0px 0px 0px 8px rgba(255, 255, 255, 0.25);
			}
	...
	#footer {
		...
		#footer .copyright {
			...
			#footer .copyright .icons a {
				border-radius: 100%;
				box-shadow: 0px 0px 0px 1px rgba(0, 0, 0, 0.1), 0px 0px 0px 4px $cajas, 0px 0px 0px 5px rgba(0, 0, 0, 0.1);
				display: block;
				font-size: 1em;
				height: 3em;
				line-height: 3em;
...
#Results {
box-shadow: -20px 0px 20px 2px rgba(0, 0, 0, 0.48);
    overflow-y:auto;
    position: fixed;
    background: $texto;
    top: 0px;
