<?php
	...
	exec("cp LaTeX/templates/templateEntNew.tex LaTeX/{$name}dir/");
	...
	$comandoRubber2 = "cd LaTeX/{$name}dir; /usr/local/texlive/2018/bin/x86_64-linux/xelatex --shell-escape -interaction=nonstopmode templateEntNew.tex && /usr/local/texlive/2018/bin/x86_64-linux/xelatex --shell-escape -interaction=nonstopmode templateEntNew.tex && mv templateEntNew.pdf $name2.pdf";
